<!-- page that shows leave balance of the  employee -->
...
<body>
    ...
    <ul>
        ...
        <li><a href="/employeeLeavePolicies">Leave Policies</a></li>
...
<div class="container" style="margin-top:100px;margin-bottom:0px;margin-left:270px;min-height:70vh;">
	...
	<div class="card text-center" style="width: 60rem;">
		...
		<div align="center">
				...
				<header class="bg-primary text-center py-5 mb-4">
				  <div class="container">
				    <h1 class="font-weight-light text-white"> Leave Balance for the Quarter</h1>
				  </div>
				</header>
				 <div class="row">
				    <!-- Leave  1 -->
				    <div class="col-xl-6 col-md-8 mb-4">
				      <div class="card border-10 border border-primary shadow">
				        <div class="card-body text-center">
				          <h5 class="card-title mb-2">Leave 1</h5>
			          <div class="card-text text-black-50"><h2 class="text-white bg-primary">Sick Leaves</h2><br><br><h1 class="text-body font-weight-bold">${sickLeaves}</h1></div>
				        </div>
				      </div>
				    </div>
				    <!-- Leave  2 -->
				    <div class="col-xl-6 col-md-8 mb-4">
				      <div class="card border-10 border border-primary shadow">
				        <div class="card-body text-center">
				          <h5 class="card-title mb-0">Leave 2</h5>
				          <div class="card-text text-black-50 "><h2 class="text-white bg-primary">Earned Leaves</h2><br><br><h1 class="text-body font-weight-bold">${earnedLeaves}</h1></div>
				        </div>
				      </div>
				    </div>
