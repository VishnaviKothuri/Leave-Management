				    ...
				    <div class="col-xl-12 col-md-8 mb-4">
				      <div class="card border-10 border border-primary shadow">
				        <div class="card-body text-center">
				          ...
				          <div class="card-text text-black-50 "><h2 class="text-white bg-primary">Earned Leaves</h2><br><br><p class="text-body">You can apply for a maximum of <b>five</b> earned leaves in each quarter resulting to a total of <b>tewnty</b> sick leaves in a year. Depending on the current leave situation your leave will be approved or rejected.Once rejected wait for a day to re-apply your leave.</p></div>
				        </div>
				      </div>
				    </div>
				    <!-- Policy 3 -->
				    <div class="col-xl-12 col-md-8 mb-4">
				      <div class="card border-10 border border-primary shadow">
				        <div class="card-body text-center">
				          ...
				          <div class="card-text text-black-50"><h2 class="text-white bg-primary" >Loss of Pay Leaves</h2><br><br><p class="text-body">Once all your earned leaves are over if you apply for a leave then automatically it becomes a LOP. </p></div>
				        </div>
				      </div>
				    </div>
