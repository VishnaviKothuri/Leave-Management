<!-- page that shows leave requests of the employees.page belongs to manager -->
					...
					<tbody>
						...
						<!-- construct an "update" link with customer id -->		   
							<tr>
                                ...
                                <td><a type ="button" class="btn btn-warning" href="/manage-leaves/reject/${leaveRequests.id}">reject</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
